...
Built entirely in Microsoft Excel, this dashboard showcases the capability to perform end-to-end data cleaning, analysis, and visualization without external BI tools — a skill highly relevant for Business Analyst and Data Analyst roles.
